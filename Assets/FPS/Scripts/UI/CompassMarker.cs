...
namespace Unity.FPS.UI
{
    public class CompassMarker : MonoBehaviour
    {
        ...
        public void Initialize(CompassElement compassElement, string textDirection = null)
        {
            ...
            //else
            //{
            //    collectibleController = compassElement.transform.GetComponent<CollectibleController>();

            //    if (collectibleController)
            //    {
            //        collectibleController.onDetectedTarget += DetectTarget;
            //        collectibleController.onLostTarget += LostTarget;
